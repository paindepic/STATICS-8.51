...
public:
	...
	TArray<class ATVPostProcessBP_C*>             CallFunc_GetAllActorsOfClass_OutActors_1;          // 0x0048(0x0010)(ZeroConstructor, ReferenceParm)
	...
	class ATVPostProcessBP_C*                     CallFunc_Array_Get_Item_1;                         // 0x0060(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class ABP_FortniteLobbyLightSwitcher_C*> CallFunc_GetAllActorsOfClass_OutActors_2;        // 0x0080(0x0010)(ZeroConstructor, ReferenceParm)
	class ABP_FortniteLobbyLightSwitcher_C*       CallFunc_Array_Get_Item_2;                         // 0x0090(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
