...
public:
	...
	class UFortMatchmakingContext*                CallFunc_GetContext_ReturnValue_1;                 // 0x0020(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FString                                 CallFunc_GetCustomMatchmakingKey_ReturnValue;      // 0x0028(0x0010)(ZeroConstructor, HasGetValueTypeHash)
