...
namespace Offsets
{
	constexpr int32 GObjects          = 0x064A0090;
	constexpr int32 AppendString      = 0x0214EC80;
	constexpr int32 GNames            = 0x0649BA70;
	constexpr int32 GWorld            = 0x065A5CF0;
	constexpr int32 ProcessEvent      = 0x022F2990;
	constexpr int32 ProcessEventIdx   = 0x00000040;
    constexpr int32 Free              = 0x02084780;
    constexpr int32 Realloc           = 0x02093D50;
}
