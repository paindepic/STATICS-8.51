...
public:
	...
	bool                                          CallFunc_CheckIfUserIsSpecialS7_UserIsSpecial_1;   // 0x00D1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TDelegate<void(class AFortGameStateAthena* GameState, const class UFortPlaylist* Playlist, const struct FGameplayTagContainer& PlaylistContextTags)> K2Node_CreateDelegate_OutputDelegate_1; // 0x0168(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, const struct FVector& HitLocation, class UPrimitiveComponent* FHitComponent, class FName BoneName, const struct FVector& Momentum)> K2Node_CreateDelegate_OutputDelegate_2; // 0x018C(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(class AFortPlayerController* Controller, const class UFortQuestItemDefinition* QuestDef, class FName BackendName, int32 CompletionCount, bool ObjectiveCompleted, bool QuestCompleted)> K2Node_CreateDelegate_OutputDelegate_3; // 0x019C(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(class AFortPlayerController* Controller, const class UFortQuestItemDefinition* QuestDef, class FName BackendName, int32 CompletionCount, bool ObjectiveCompleted, bool QuestCompleted)> K2Node_CreateDelegate_OutputDelegate_4; // 0x01AC(0x0010)(ZeroConstructor, NoDestructor)
	...
	bool                                          CallFunc_CheckIfUserIsSpecialS7_UserIsSpecial_2;   // 0x01C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TArray<class AActor*>                         Temp_object_Variable_2;                            // 0x01E8(0x0010)(ConstParm, ZeroConstructor, ReferenceParm)
	...
	bool                                          CallFunc_EqualEqual_IntInt_ReturnValue;            // 0x0309(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
