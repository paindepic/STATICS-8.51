...
void USocialNameTextBlock::SetNickNameColor(const struct FColor& InColor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SocialNameTextBlock", "SetNickNameColor");

	Params::SocialNameTextBlock_SetNickNameColor Parms{};
...
void USocialListEntry_SocialUser::OnUserPresenceChanged(EOnlineStatus OnlineStatus)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("SocialListEntry_SocialUser", "OnUserPresenceChanged");

	Params::SocialListEntry_SocialUser_OnUserPresenceChanged Parms{};
