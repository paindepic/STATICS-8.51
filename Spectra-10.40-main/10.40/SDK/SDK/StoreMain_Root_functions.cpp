...
// Parameters:
// bool                                    HasCurrencyOnOtherPlatforms                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
// const class FText&                      SplitCurrencyMessage                                   (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)

void UStoreMain_Root_C::UpdateSpliCurrencyMessage(bool HasCurrencyOnOtherPlatforms, const class FText& SplitCurrencyMessage)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("StoreMain_Root_C", "UpdateSpliCurrencyMessage");

	Params::StoreMain_Root_C_UpdateSpliCurrencyMessage Parms{};

	Parms.HasCurrencyOnOtherPlatforms = HasCurrencyOnOtherPlatforms;
	Parms.SplitCurrencyMessage = std::move(SplitCurrencyMessage);
