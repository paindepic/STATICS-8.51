...
void AProp_QuestInteractable_Parent_C::BlueprintOnInteract(const class AFortPawn* InteractingPawn_0)
{
	static class UFunction* Func = nullptr;
...
void AProp_QuestInteractable_Parent_C::Server_QuestObjectiveCompleted(class AFortPawn* InteractingPawn_0)
{
	static class UFunction* Func = nullptr;
...
// bool                                    QuestCompleted_0                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void AProp_QuestInteractable_Parent_C::Server_QuestObjectiveUpdated(class AFortPlayerController* Controller, const class UFortQuestItemDefinition* QuestDef, class FName BackendName, int32 CompletionCount, bool ObjectiveCompleted, bool QuestCompleted_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.QuestCompleted_0 = QuestCompleted_0;
...
void AProp_QuestInteractable_Parent_C::DebugModeForceInteract(class ABuildingActor* SelfActor, class AFortPawn* InteractingPawn_0)
{
	static class UFunction* Func = nullptr;
...
class FText AProp_QuestInteractable_Parent_C::BlueprintGetInteractionString(const class AFortPawn* InteractingPawn_0) const
{
	static class UFunction* Func = nullptr;
...
bool AProp_QuestInteractable_Parent_C::BlueprintCanInteract(const class AFortPawn* InteractingPawn_0) const
{
	static class UFunction* Func = nullptr;
