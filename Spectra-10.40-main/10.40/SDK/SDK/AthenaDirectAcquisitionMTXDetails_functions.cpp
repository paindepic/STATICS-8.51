...
// const TArray<struct FPurchasedItemInfo>&Purchases                                              (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)

void UAthenaDirectAcquisitionMTXDetails_C::HandleRealMoneyPurchaseComplete(const bool bSuccess, const TArray<struct FPurchasedItemInfo>& Purchases)
{
	static class UFunction* Func = nullptr;
