...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class APhysicsObject*                   PhysicsObject                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ATrap_Floor_BouncePad_C::PhysicsObjectLaunch(class APhysicsObject* PhysicsObject)
{
	static class UFunction* Func = nullptr;
