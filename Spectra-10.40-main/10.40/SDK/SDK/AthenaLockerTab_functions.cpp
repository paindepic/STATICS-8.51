...
// Parameters:
// bool                                    InProcessed                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UAthenaLockerTab_C::SetCustomizationSelectionBeingProcessed(bool InProcessed)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaLockerTab_C", "SetCustomizationSelectionBeingProcessed");

	Params::AthenaLockerTab_C_SetCustomizationSelectionBeingProcessed Parms{};

	Parms.InProcessed = InProcessed;
