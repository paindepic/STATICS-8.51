...
// Parameters:
// int32*                                  LastLevel                                              (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UAthenaSeasonPageWidget_C::GetLastLevel(int32* LastLevel)
{
	...
	Params::AthenaSeasonPageWidget_C_GetLastLevel Parms{};

	UObject::ProcessEvent(Func, &Parms);

	if (LastLevel != nullptr)
		*LastLevel = Parms.LastLevel;
}
