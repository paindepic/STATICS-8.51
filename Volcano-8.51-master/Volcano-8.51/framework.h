...
UEType* StaticFindObject(const std::string& ObjectName, UClass* Class = UObject::StaticClass())
{
    ...
    return (UEType*)StaticFindObjectOG(Class, nullptr, WideName.c_str(), false);
}
...
T* StaticLoadObject(const std::string& Name)
{
    ...
    if (!Object)
    {
        ...
        Object = (T*)StaticLoadObjectOG(T::StaticClass(), nullptr, WideName.c_str(), nullptr, 0, nullptr, false, nullptr);
    }
