...
{
public:
	TSoftObjectPtr<class UMaterialInstance>       CallFunc_Array_Get_Item;                           // 0x0000(0x0028)(HasGetValueTypeHash)
	TSoftObjectPtr<class UMaterialInstance>       CallFunc_Array_Get_Item_1;                         // 0x0028(0x0028)(HasGetValueTypeHash)
	class UFortSettingsContext*                   CallFunc_GetContext_ReturnValue;                   // 0x0050(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
