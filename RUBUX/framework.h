...
inline UFortBuildingItemDefinition* Floor = UObject::FindObject<UFortBuildingItemDefinition>("FortBuildingItemDefinition BuildingItemData_Floor.BuildingItemData_Floor");
inline UFortBuildingItemDefinition* Roof = UObject::FindObject<UFortBuildingItemDefinition>("FortBuildingItemDefinition BuildingItemData_RoofS.BuildingItemData_RoofS");
inline UFortBuildingItemDefinition* Stair = UObject::FindObject<UFortBuildingItemDefinition>("FortBuildingItemDefinition BuildingItemData_Stair_W.BuildingItemData_Stair_W");
inline UFortBuildingItemDefinition* Wall = UObject::FindObject<UFortBuildingItemDefinition>("FortBuildingItemDefinition BuildingItemData_Wall.BuildingItemData_Wall");
inline UFortEditToolItemDefinition* EditTool = UObject::FindObject<UFortEditToolItemDefinition>("FortEditToolItemDefinition EditTool.EditTool");

inline std::vector<UAthenaCharacterItemDefinition*> Characters{};
inline std::vector<UAthenaPickaxeItemDefinition*> Pickaxes{};
inline std::vector<UAthenaBackpackItemDefinition*> Backpacks{};
inline std::vector<UAthenaGliderItemDefinition*> Gliders{};
inline std::vector<UAthenaSkyDiveContrailItemDefinition*> Contrails{};
...
typedef void (*BotTickCallback)();
inline BotTickCallback BotTick = nullptr;
...
inline void (*AbilitySpecConstructor)(FGameplayAbilitySpec*, UGameplayAbility*, int, int, UObject*) = nullptr;
inline FGameplayAbilitySpecHandle(*GiveAbilityAndActivateOnce)(UAbilitySystemComponent*, FGameplayAbilitySpecHandle*, FGameplayAbilitySpec) = nullptr;
...
void TickFlushHook(UNetDriver* a1)
{
    ...
    if (BotTick && Globals::bBotsEnabled)
    {
        BotTick();
    }
...
template<typename T>
void HookVTable(int Index, void* Detour, void** OG = nullptr)
{
    auto Obj = GetDefObj<T>();
    if (!Obj)
    {
        return;
    }
    VirtualHook(Obj, Index, Detour, OG);
}
