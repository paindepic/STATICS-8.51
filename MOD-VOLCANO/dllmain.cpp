...
// MOD-VOLCANO: Integrated with SPECTRA bot system for Fortnite 8.51
#include "gaymode.h"
#include "framework.h"
#include "PC.h"
#include "Farming.h"
...
// SPECTRA Bot System Integration
#include "Bots/AIS/AIController.h"
#include "Bots/AIS/ServerBotManager.h"
#include "Bots/AIS/Bots.h"
#include "Bots/AIS/BotNames.h"
#include "Bots/PlayerBot/PlayerBots.h"

// Bot system initialization
namespace BotIntegration
{
    bool bBotSystemInitialized = false;

    void InitBotSystem()
    {
        if (bBotSystemInitialized)
            return;

        LOG_("[MOD-VOLCANO] Initializing SPECTRA Bot System...");

        // Initialize ServerBotManager hooks
        ServerBotManager::HookAll();

        // Initialize AI Controller hooks
        ...
        LOG_("[MOD-VOLCANO] SPECTRA Bot System Initialized Successfully!");
    }
}
...
DWORD Main(LPVOID)
{
    ...
    // unlocked console!
    SetConsoleTitleA("MOD-VOLCANO on Top!!!");

    LOG_("MOD-VOLCANO 8.51 - Integrated with SPECTRA Bot System");
    LOG_("Building enhanced server with AI and Player Bots...");
    ...
    *BYTE = 0x74;
    ...
    // Initialize MOD-VOLCANO Bot System Integration
    BotIntegration::InitBotSystem();

    LOG_("[MOD-VOLCANO] All systems initialized successfully!");
